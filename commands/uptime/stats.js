...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        var embed = new discord.MessageEmbed()
            .setColor("RANDOM")
            .setTitle("<a:musica:785432181065121802> Your Project Stats <a:musica:785432181065121802>");
        
        var count = 0;
        all.forEach(async (data) => {
            count++;
            if(count === 26) return;
            embed.addField(`**${count}**. \`${data.projectURL}\``,`<:LLdotwhite:793780355953065986> Last Pinged: ${data.updatedAt ? formatDate(data.updatedAt) : 'Not Measured'}\n<:LLdotwhite:793780355953065986> Total Pings: ${data.pinged}`);
        });        
