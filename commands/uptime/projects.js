...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        }; // THIS WILL ONLY GET THE DATA FOR THE AUTHOR
        ...
        var count = 0; // SERIAL NUMBER FOR DISPLAYING DATA

        all.forEach(async (data) => { // LOOPS THROUGH ALL DATA
            // ADDS THE DATA IN CONTENT VARIABLE
            count++;
